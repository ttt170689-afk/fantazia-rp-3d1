  ...
  window.FZ_TEASER_MALL = {
    ...
    build: function (scene, ox, oy, oz, opts) {
      ...
      function buildMALL() {
          ...
          // восточная стена — С ПРОЁМОМ под служебные ворота (z -20.9..-17.1, высота 0..3.4)
          ...
          // ════ СЛУЖЕБНЫЙ КОМПЛЕКС v7: БРОНЕВОРОТА B1 + ГРУЗОВОЙ ЛИФТ ════
          // (ворота z=-19 с настоящим проёмом в лестничный просвет,
          //  грузовой лифт z=-24 с живым табло B1→B5 и светом из щели дверей)
          GM.brd = [];   // старых досок больше нет (оставлено для совместимости)
